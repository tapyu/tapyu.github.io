...
% 2. Aimed journals
% 2.1 Journal of Engineering Education (JEE) (Impact factor (2021):3.288)
% https://onlinelibrary.wiley.com/journal/21689830
% 2.2 IEEE Transactions on Education (2.74 Impact Factor)
...
\begin{document}
Mathematical origins of Disagreement Among Authors over equivalent baseband signals: A Systematic Investigation
\end{document}