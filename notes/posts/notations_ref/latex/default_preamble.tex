...
%%%%%%%%% references %%%%%%%%%
\usepackage[colorlinks=true, allcolors=blue]{hyperref} % make references blue and clickable
%%%%%%%%% bibliography %%%%%%%%%
...
\usepackage{IEEEtrantools} % provides the IEEEeqnarray environment. WARNING: this package may crash you build if the \documentclass is IEEE-like, e.g., IEEEtran. In this case, delete this line!
...
\NewDocumentCommand{\limean}{ E{_}{{}} m }{
    \ensuremath{
        \IfValueTF{#1}{%
