...
\begin{xltabular}{\textwidth}{XX}
	...
	\(\oint_C, \varointctrclockwise_C\)                                                                                                                                                                                                        & Line integral (also called contour integral) along the closed contour \(C\). The arrow indicates the contour integral orientation, which is counterclockwise, by default.                                                                                                              \\ \hline
